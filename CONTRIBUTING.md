### How to Contribute
1. Fork the `Bibliographical-hybrid-mobile-app` repository
2. Clone the `Bibliographical-hybrid-mobile-app` repository to your local machine
  ```
...
3. Change directory to the cloned repository
  ```
  cd Bibliographical-hybrid-mobile-app
  ```
